...
public class Question2 {
    ...
    public static void run() {
        int[] s1Sides = {10, 20};
        Shape2 s1 = new Shape2(ShapeType.Rectangle, s1Sides) {
        ...
        int[] s2Sides = {10};
        Shape2 s2 = new Shape2(ShapeType.Square, s2Sides) {
            @Override
            public float perimeter() {
                return s2Sides[0]*4;
            }
        ...
        int[] s3Sides = {12};
        Shape2 s3 = new Shape2(ShapeType.Circle, s3Sides) {
            @Override
            public float perimeter() {
        ...
        int[] s4Sides = {8, 12, 12};
        Shape2 s4 = new Shape2(ShapeType.Triangle, s4Sides) {
            @Override
            public float perimeter() {
